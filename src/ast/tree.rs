 ...
 * However, manual changes have been made since.
 */
...
#[derive(Educe, Debug, Clone)]
#[educe(PartialEq, Eq, Hash)]
pub struct Alias<'a, N: Eq + Hash + Debug + Clone> {
    pub name: N,
...
impl<'a, N: Eq + Hash + Debug + Clone> Spanned for Alias<'a, N> {
    #[inline]
    fn span(&self) -> Span {
        self.span
    }
